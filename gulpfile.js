...
gulp.task('styles', () => {
    ...
    return gulp
        .src(stylesheet)
        .pipe(postcss([pcImport(), pcNested(), tailwind(tailwindConfig), pcColor(), pcClean()]))
        .pipe(
            purgecss({
                content: ['_includes/**/*.html', '_layouts/**/*.html', 'content/**/*.html', '_data/**/*.yml'],
...
gulp.task('serve', () => {
    ...
    gulp.watch(['_includes/**/*.html', '_layouts/**/*.html', 'content/**', '_data/**/*.yml'], gulp.series(['jekyll']));
